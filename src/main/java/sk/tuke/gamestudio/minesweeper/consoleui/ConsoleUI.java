...
//                Minesweeper.getInstance().setSetting(s);
        ...
        try{
            scoreService.addScore(new Score("slk/tuke/gamestudio", userName,gameScore,new Date()));
        }catch(Exception e){
    ...
    private void printBestScores() {
        ...
        try{
            List<Score> bestScores = scoreService.getBestScores("slk/tuke/gamestudio");
