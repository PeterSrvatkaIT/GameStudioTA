...
public class CommentServiceJDBC implements CommentService {
    ...
    private static final String STATEMENT_ALL_COMMENTS = "SELECT game, username, comment, commented_on FROM comment " +
            "WHERE game= ? ORDER BY commented_on DESC";
    ...
    @Override
    public List<Comment> getAllComments(String comment) {
        return null;
    }
    ...
    public List<Comment> getComments(String game) {
        ...
        try( var connection =DriverManager.getConnection(JDBC_URL, JDBC_USER, JDBC_PASSWORD);
             var statement = connection.prepareStatement(STATEMENT_ALL_COMMENTS)
        )
        {
